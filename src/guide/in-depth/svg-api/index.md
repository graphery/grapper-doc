...
**Graphane** includes a flexible API to simplify the construction and manipulation of SVG from
...
generated, and it is possible to query and manage the graph from Javascript with the Graphane SVG
...
Why an SVG API? We have intensively created and manipulated SVG graphics from Graphane, as a 
...
This is the same code with Graphane SVG API:
...
Graphane dynamically constructs the method chain to make successive calls. When you call a setter 
